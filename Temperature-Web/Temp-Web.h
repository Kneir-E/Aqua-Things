...
const char* webpage = R"=====(
  ...
  <body>
    <h1>ESP32 Wireless Temperature Sensor</h1>
        ...
        fetch('/temperature')
          ...
          .then(data => {
            ...
            if(status=="Detected"){
              ...
              document.getElementById('Message').innerHTML  = "Sensor Not Detected. Connect DS18B20 to MCU then restart.<br>&emsp;VCC to 3.3V<br>&emsp;DATA to pin 2";
            }else{
